                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td><a href="{{route('post', $reply->comment->post->slug)}}">{{$reply->comment->post->title}}</a></td>
                   ...
                   <div class="modal fade" id="deleteModal-{{$reply->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-footer">
                            ...
                            <form id="deleteReply-{{$reply->id}}" action="{{ route('admin.comment-reply.destroy', $reply->id) }}" method="POST" class="d-none">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
