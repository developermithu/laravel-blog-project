          ...
          <div class="row justify-content-between align-items-center d-flex">
            <div class="col-lg-8 top-left">
              ...
              <ul>
                ...
                <li><a style="color:red">{{$query}}</a></li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div class="col-lg-8">
                ...
                @if ($tags->count() > 0)
                    ...
                    <div class="single-posts col-lg-6 col-sm-6">
                        <img class="img-fluid" src="{{asset('storage/post/' .$tag->post->image)}}" alt="{{$tag->post->title}} photo" />
                        <div class="date mt-20 mb-20">
                            {{$tag->post->created_at->diffForHumans()}}
                        </div>
                        <div class="detail">
                          ...
                          ></i>
                          <a href="#">{{$tag->post->view_count}}  Views</a>
                          </p>
                        </div>
                      </div>
                    @endforeach
